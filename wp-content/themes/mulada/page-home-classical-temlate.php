<?php
/*
	/* Template Name: Home Classical Template
...
get_header(); ?>
	...
	<?php mulada_site_sub_content_start(); ?>
		<?php mulada_container_before(); ?>
			...
			<?php 
			$hide_home_title = get_theme_mod( 'hide_home_title' );
			if( !$hide_home_title == '1' ) :
			?>
				<section class="category-archive-title">
					<h1><span><?php printf( esc_html__( 'Home', 'mulada' ) ); ?></span></h1>
				</section>
			<?php endif; ?>
											...
											<div class="post-bottom">
												<?php if( !$hide_categoryarchive_post_read_more == '1' ) : ?>
													<div class="post-read-more">
														<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php printf( esc_html__( 'Leer Mas', 'mulada' ) ); ?></a>
													</div>
												<?php endif; ?>
