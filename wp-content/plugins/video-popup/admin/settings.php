...
function vp_al_op_youtube_options_cb_free(){
    ?>
        <fieldset>
            ...
            <label title="<?php esc_attr_e('Disable YouTube related videos. This option for YouTube only. This option for the Premium Extension.', 'video-popup'); ?>">
            ...
            <br>
            <label title="<?php esc_attr_e('Disable YouTube video title and player actions. This option for YouTube only. This option for the Premium Extension.', 'video-popup'); ?>">
                <input type="checkbox" value="1" disabled="true"><span style="color:#999 !important;"><?php _e('Disable Info (Premium)', 'video-popup'); ?>.</span>
            </label>
            <br>
