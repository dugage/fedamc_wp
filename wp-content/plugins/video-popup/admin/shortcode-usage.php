				...
				<div class="postbox">
					...
					<div class="inside" style="padding: 12px !important;margin: 0 !important;">
						...
						<div class="main">
							...
							<p><strong style="background-color: #ddd;">rv=""</strong> <?php _e('enter "1" to disable YouTube Related videos, for YouTube only (in the Premium Extension only).', 'video-popup'); ?></p>
							...
							<p><strong style="background-color: #ddd;">di=""</strong> <?php _e('enter "1" to disable YouTube video title and player actions, for YouTube only (in the Premium Extension only).', 'video-popup'); ?></p>
