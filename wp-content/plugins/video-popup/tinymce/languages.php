...
function video_popup_tinymce_plugin_translation() {
    $strings = array(
        ...
        'o_t_dis_rel_vid' => __('Disable YouTube related videos. This option for YouTube only. This option for the Premium Extension.', 'video-popup'),

        'o_l_dis_rel_vid_prm' => __('Disable Related Videos', 'video-popup'),

        'o_t_dis_rel_vid_prm' => __('Disable YouTube related videos. This option for YouTube only.', 'video-popup'),
        ...
        'o_l_dis_info' => __('Disable Info (Premium)', 'video-popup'),

        'o_t_dis_info' => __('Disable YouTube video title and player actions. This option for YouTube only. This option for the Premium Extension.', 'video-popup'),

        'o_l_dis_info_prm' => __('Disable Info', 'video-popup'),

        'o_t_dis_info_prm' => __('Disable YouTube video title and player actions. This option for YouTube only.', 'video-popup'),
