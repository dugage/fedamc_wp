...
(function ( $ ) {
    ...
    $.fn.YouTubePopUp = function(options) {
        ...
        $(this).on('click', function (e) {
            ...
            $(".YouTubePopUp-Wrap").append('<div class="Video-PopUp-Content"><div class="vp-flex'+disWrapClass+videoType+'"><span class="YouTubePopUp-Close"></span>'+iframe_element+'</div></div>');
